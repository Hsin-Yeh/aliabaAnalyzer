...
***** 2. Push your code, and share how you accomplish these exercises, also learn from others 
***** 3. Don't be shy to change the code in your own branch, the master branch should be just a template. Be Wild! If anything went wrong, the master branch is still there for you to reset!
